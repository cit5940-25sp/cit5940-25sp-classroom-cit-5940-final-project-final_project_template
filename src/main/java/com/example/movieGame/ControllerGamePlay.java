...
public class ControllerGamePlay {
    ...
    public String handleMove(@RequestParam("move") String move, Model model) {
        // Replace with actual game logic
        String response = "You entered: " + move;
...
//     *
//     */
//    public ControllerGamePlay(String player1Name, String player2Name) {
